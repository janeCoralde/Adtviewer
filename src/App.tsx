...
const App: React.FC = () => {
  ...
  const onIModelConnection = async (_imodel: IModelConnection) => {
    ...
    console.log("Fetching data for 66-TT-301");
    // Only start the fetching when imodel has connected.
    setInterval(async () => {
      let prefix = "66-TT-301";
      AdtDataLink.fetchDataForNode(prefix).then((temperature) => {
          (window as any).adtEmitter.emit('temperature data', temperature);
      }).catch(() => {});
  ...
  return (
    <div className="viewer-container">
      ...
      <Viewer
        ...
        changeSetId="c5ddde632931613d6d104c63c4fcfac72f06f8af"
